...
def save_model(model):
    ...
    model_path = os.path.join("models", "optimal_model.pkl")
    joblib.dump(model, model_path) # Save scaler for future use
    print("Best model saved successfully!")
...
def main():
    ...
    optimal_model = hyperparameter_tuning(X_train, y_train)
    explain_model(optimal_model, X_train, X_test)
    save_model(optimal_model)
